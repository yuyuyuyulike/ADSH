...
data class DshPalette(
    ...
    /** --dsw-alias-markdown-inline-code（行内代码的底：浅 neutral-50 / 深 neutral-800） */
    val inlineCode: Color,
    /** --dsw-alias-link（Markdown 链接：浅 deepseek-500 / 深 deepseek-400） */
    val link: Color,
...
val LightDshPalette = DshPalette(
    ...
    // --dsw-alias-markdown-inline-code = --dsw-static-neutral-50
    inlineCode = Color(0xFFFAFAFA),
    // --dsw-alias-link = --dsw-static-deepseek-500
...
val DarkDshPalette = DshPalette(
    ...
    // --dsw-alias-markdown-inline-code = --dsw-static-neutral-800
    inlineCode = Color(0xFF292929),
    // --dsw-alias-link = --dsw-static-deepseek-400
    link = Color(0xFF7AAAFF),
